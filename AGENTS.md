...
fixed Oxlint executor with M2.2 single-file input binding and applicability.
It is not yet an agent. Keep changes scoped to the active increment; durable
evidence storage and recovery remain M2 work.
