...
| Gentle AI qualification | In progress | Contract, capabilities, isolated bootstrap and deterministic parity lane passed; high-risk review timed out before mutation and recovery could not create a successor; model-backed review and usable recovery remain |
