...
| Codex-backed Gentle reviewer host | Implemented for one read-only lens | Pi runs a bounded reviewer with Tesota's Codex credential store and saves candidate-bound structured evidence; Gentle capture and multi-lens settlement remain open |
