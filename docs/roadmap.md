...
| Cyclomatic-complexity pilot | Passed for two existing owners | `lifecycleStatus` fell from 26 to 6 and `interpretOxlint` from 35 to 12 with characterization coverage; nine other functions remain above 20 and no permanent gate is yet adopted |
