...
| Gentle AI qualification | In progress | Package contract, capabilities and isolated bootstrap passed; high-risk lens selection reached a bounded timeout before mutation; pre-native recovery could not create a successor; model-backed review and usable recovery remain |
